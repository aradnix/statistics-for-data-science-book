...
variance
\[ \mathbb{E}[X] = \frac{1-p}{p},\;\;\; V[X] = \frac{1-p}{p^2} \] \todo{Add base
example that serves as base experiment.} Ussing this base experiment we cant try
...
\todo{Add base example that serves as base experiment.} Ussing this base
experiment we cant try to fit other rand. exp. and see if this distribution is
valid.
\begin{figure}[!ht]
    \begin{minipage}{0.45\linewidth}
...
\[ \mathbb{E}[X] = \lambda,\;\;\; V[X] = \lambda \] \todo{Add base example that
serves as base experiment.} Ussing this base experiment we cant try to fit other
...
\begin{multicols}{2}
    ...
    \end{multline*}
\end{multicols}
\missingfigure{square random vector showing the only true indepence variables}
...
distributions. \todo{remove this last paragraph?}
...
individuals). \todo{review this and write about his generalized form}
